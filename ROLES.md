...
| **5. The SQL Tester** | Elizade Vian Alberto Leonel| Intenta romper la BD. Valida integridad referencial y tipos de datos. | `tests/bug_report.md`, `tests/test_cases.sql` |
